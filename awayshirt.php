...
<html>
    ...
    <body>
        ...
        <div class="shirt">
            ...
            <p class="here">If you want the home shirt click <a href="shirts.php">here</a></p>
            <img class="away" src="images/awayshirt.jpeg" alt="bayern away shirt image">
            <form method="post" action="awayshirt.php">
